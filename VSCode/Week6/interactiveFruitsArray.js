// Setup an array
const fruits = ["banana", "orange", "apple", "pineapple", "tangerine", "lychee", "peach"];
...
$('#array-methods-form').on('submit', function(event) {
  ...
  let arraySelectValue = $("#array-methods-select-list").val();

  // Setup array variables
  let arrayTransform, arrayMod;
  ...
  $('#fruit-variable-mod').text("mods to fruits: " + JSON.stringify(arrayMod)).show(300);
  $('#fruit-variable').text("modified fruits = " + JSON.stringify(fruits)).show(400);
